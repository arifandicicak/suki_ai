...
export function handleFirestoreError(error: unknown, operationType: OperationType, path: string | null) {
  ...
  // Safe circular JSON stringifying helper function
  ...
  const serializedErr = safeJsonStringify(errInfo);
...
export { doc, getDoc, setDoc, updateDoc, serverTimestamp, signInWithPopup };
